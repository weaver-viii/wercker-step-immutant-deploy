...
ssh -i $PRIVATEKEY_PATH -o "StrictHostKeyChecking no" -p 2222 deploy@localhost "bash $IMMUTANT_SCRIPT $IMMUTANT_ENVIRONMENT"
ssh -i $PRIVATEKEY_PATH -o "StrictHostKeyChecking no" -p 2223 deploy@localhost "bash $IMMUTANT_SCRIPT $IMMUTANT_ENVIRONMENT"
